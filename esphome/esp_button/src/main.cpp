...
void setup() {
  ...
  wificomponent->set_use_address("esp_button.local");
  ...
  binary_sensor::GPIOBinarySensorComponent *simple_button = App.make_gpio_binary_sensor("Simple Button", 13);
